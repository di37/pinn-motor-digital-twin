...
- **H4:** parameter drift follows material physics. Across temperature bands the fitted `R_s` trend is positive and the fitted `ψ_f` trend is negative, with signs stable across all 3 seeds.
