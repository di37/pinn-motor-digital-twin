...
- **2026-08-15 - Eighth rung joins the audit (second reviewer, inductive bias).** sl added the P2 structured-coupled hybrid. H1's plausibility claim extends to all eight rungs, and H5's cross-check becomes four-way: LPTN, TNN, PINN, and P2 estimates of the shared thermal parameters lie within 30 % of one another at full supervision. The original seven-rung and three-way phrasings stand recorded above, unedited.
